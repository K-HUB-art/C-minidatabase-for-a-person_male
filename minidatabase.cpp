...
void searchDatabase();
void removePerson_maleFromDatabase();
...
int main()
{
    ...
    do
    {
        ...
        cout << "1. Add Person_male" << endl;
        cout << "2. Show All People" << endl;
        cout << "3. Save People to File" << endl;
        cout << "4. Load People from File" << endl;
        cout << "5. Search for a Person_male" << endl;
        cout << "6. Remove Person_male from DataBase" << endl;
...
void showPeople()
{
    if(peopleInDataBase > 0)
    {
        ...
        {
            cout << "Person_male index: " << (i+1) << endl;
...
void searchDatabase()
{
    ...
    {
        string name;
        cout << "Type a name of person_male you want to look for: ";
        cin >> name;
